...
function ebp_init() {
	...
	// Load Elementor widget integration when Elementor is ready.
	add_action( 'elementor/init', 'ebp_elementor_init' );
}

if ( ! function_exists( 'ebp_elementor_init' ) ) {
	function ebp_elementor_init() {
