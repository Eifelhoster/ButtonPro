...
class EBP_Admin {
		...
		<div class="wrap ebp-admin-wrap ebp-docs-wrap">
			...
			<div class="ebp-docs-header">
				<img src="<?php echo esc_url( $logo_url ); ?>"
					alt="<?php esc_attr_e( 'eifelhoster.de', 'eifelhoster-buttons-pro' ); ?>"
					class="ebp-docs-logo" />
	...
	/**
	 * Render the documentation content sections.
	 * Called from render_docs_page() and from the Classic-Editor docs popup.
	 */
	public static function render_docs_content() {
		?>
		<!-- ============================================================ -->
		<!-- 1. Einführung                                                  -->
		<!-- ============================================================ -->
